...
const createFetchAction = (type = '') => (param, extra, successCallback = noop, failCallback = noop) => (dispatch, getState) => {
    ...
    req.then(res => {
        ...
        const curState = typeof getState === 'function' ? getState() : null;
        customDispatch(res, dispatch, curState);
